...
//            "{\"type\":\"Feature\",\"properties\":{\"mag\":6,\"place\":\"Pacific-Antarctic Ridge\",\"time\":1451986454620,\"updated\":1459202978040,\"tz\":-540,\"url\":\"http://earthquake.usgs.gov/earthquakes/eventpage/us10004bgk\",\"detail\":\"http://earthquake.usgs.gov/fdsnws/event/1/query?eventid=us10004bgk&format=geojson\",\"felt\":0,\"cdi\":1,\"mmi\":0,\"alert\":\"green\",\"status\":\"reviewed\",\"tsunami\":0,\"sig\":554,\"net\":\"us\",\"code\":\"10004bgk\",\"ids\":\",us10004bgk,gcmt20160105093415,\",\"sources\":\",us,gcmt,\",\"types\":\",cap,dyfi,geoserve,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,\",\"nst\":null,\"dmin\":30.75,\"rms\":0.67,\"gap\":71,\"magType\":\"mww\",\"type\":\"earthquake\",\"title\":\"M 6.0 - Pacific-Antarctic Ridge\"},\"geometry\":{\"type\":\"Point\",\"coordinates\":[-136.2603,-54.2906,10]},\"id\":\"us10004bgk\"}],\"bbox\":[-153.4051,-54.2906,10,158.5463,59.6363,582.56]}";
    ...
    /**
     * Return a List of {@link Earthquake} objects that have been parsed from the JSON response
     */
    public static List<Earthquake> fetchData(String urlRequest){
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (httpConnection.getResponseCode() == 200){
                ...
                res4rmJSON = readInputStream(inputStream);
            }else {
                Log.e(TAG, "Error reading from input stream: " + httpConnection.getResponseCode());
            }
        }catch (IOException e){
    ...
    private static String readInputStream(InputStream inputStream) throws IOException {
        ...
        BufferedReader buffedInput  =  new BufferedReader(isReader);

        String line = buffedInput.readLine();
        while (line != null) {
            finalString.append(line);
            line = buffedInput.readLine();
        }
    ...
    public static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        ArrayList<Earthquake> newQuakes = new ArrayList<>();
        ...
        try {
            ...
            JSONObject rootQuakesObj = new JSONObject(jsonResponse);
            JSONArray featuresArray = rootQuakesObj.getJSONArray("features");
            Long time = 0L;
            String url ="";
            String location = "";
            double magnitude = 0;
            for (int i= 0; i < featuresArray.length(); i++) {
                JSONObject singleFeature = featuresArray.getJSONObject(i);
                ...
                newQuakes.add(new Earthquake(magnitude, location, time, url));
            }
